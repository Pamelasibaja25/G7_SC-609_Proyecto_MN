        ...
        <div class="col-lg-8">
            <div class="card auth-card">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-5 d-none d-md-flex align-items-center justify-content-center brand-panel flex-column p-4">
                        <h1 class="mb-3">Escuela en Casa</h1>
                        <p class="mb-3">
                            Plataforma educativa para gestionar cursos, estudiantes, asistencia y rendimiento académico
                            de forma sencilla.
                        </p>
                        <ul class="mb-0 small">
