                        ...
                        <?php else: ?>
                            <?php foreach ($estudiantes as $p): ?>
                                <tr>
                                    ...
                                    <td>
                                        <button
                                            class="btn bg-body-custom text-white btn-sm mb-1"
                                            data-toggle="modal"
                                            data-target="#editar-estudiante"
                                            data-id="<?= htmlspecialchars($p['_id']) ?>"
                                            ...
                                            data-escuela="<?= htmlspecialchars($p['escuela']) ?>"
                                        >Editar</button>
...
<!-- MODAL EDITAR -->
<div class="modal fade" id="editar-estudiante" tabindex="-1" role="dialog" aria-labelledby="editarEstudianteLabel" aria-hidden="true">
...
<!-- MODAL ELIMINAR -->
<div class="modal fade" id="eliminar-estudiante" tabindex="-1" role="dialog" aria-labelledby="eliminarEstudianteLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card-header bg-body-custom text-white d-flex justify-content-between align-items-center">
