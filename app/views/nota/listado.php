                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3 text-center">
                                <a href="/G1_SC-502_JN_Proyecto/app/views/curso/registro_matricula.php" class="btn bg-body-custom text-white">Agregar</a>
                                <a href="" class="btn bg-body-custom text-white">Cancelar</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="modify-form" action="/G1_SC-502_JN_Proyecto/app/controller/estudianteController.php"
                            method="POST">
