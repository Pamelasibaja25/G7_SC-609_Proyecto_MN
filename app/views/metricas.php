                ...
                <div class="col-md-6 col-lg-5 mb-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p><strong>Estudiantes Únicos:</strong> <?= htmlspecialchars($metricas['estudiantes']); ?>
                            </p>
                ...
                <div class="col-md-6 col-lg-5 mb-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p><strong>Cursos Matriculados <?= date('Y'); ?>:</strong>
                                <?= htmlspecialchars($metricas['matriculados_anio']); ?></p>
                        </div>
                    </div>
